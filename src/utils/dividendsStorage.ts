...
export const sampleInitialDividends: DividendHolding[] = [
  {
    ...
    amount: 810,
    frequency: 'quarterly',
    payoutMonths: [4, 5, 8, 11],
    shares: 1000,
    dividendPerShare: 0.81,
    monthlyDpu: { 4: 0.81, 5: 0.81, 8: 0.81, 11: 0.75 },
    ...
    notes: 'Digrin Payable Dates: Apr ($0.81), May ($0.81), Aug ($0.81), Nov ($0.75)',
  ...
  },
  {
    ...
    totalAnnualPayout: 432,
    pastYearDividends: 432,
    ytdDividends: 360,
    expectedYearlyDividends: 432,
    monthlyAverageDividends: 36,
    currency: 'SGD',
    paymentMethodOrAccount: 'CDP',
